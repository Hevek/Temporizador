...
U can add ringtones by putting the file in "Temporizador\bin\Debug" and typing the name of it in the "ringtones.txt" file, located in the same place (don't forget to put ".mp3" after the name of the file in the "ringtones.txt").
